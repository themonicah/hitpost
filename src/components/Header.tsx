                  ...
                  >
                    ...
                    {onShowQRCode && (
                      <button
                        ...
                        role="menuitem"
                        className="w-full px-4 py-2.5 text-left text-sm text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-800 min-h-[44px] flex items-center gap-2"
                      >
