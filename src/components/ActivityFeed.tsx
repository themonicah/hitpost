...
function ActivityCard({ item }: { item: ActivityItem }) {
  ...
  return (
    <Link
      href={`/dumps/${item.dumpId}`}
      className="block bg-white dark:bg-gray-900 rounded-2xl p-4 shadow-sm hover:shadow-md transition-all duration-200 hover:scale-[1.01] active:scale-[0.99]"
    >
    ...
    return (
      <div className="bg-white dark:bg-gray-900 rounded-2xl p-8 text-center">
        ...
        <p className="text-gray-500 text-sm">
          When people view, react to, or comment on your dumps, you'll see it here
        </p>
      </div>
    );
  }
